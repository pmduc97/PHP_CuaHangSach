...
if(isset($_POST['capnhat'])){
    $kt = LoaiBo::capNhatLoai($_POST['maloai'],$_POST['tenloai']);
}
$Loai = LoaiBo::get1Loai($_GET['maloai']);
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="col-md-12">
    <?php
										if(isset($kt)){
										if($kt != 0){
										echo "Đã cập nhật : ".$_POST['tenloai'];
										}
										else {
...
<form action="" method="post">
									...
									<table class="table table-bordered text-center">
												...
												<td>
                                                                                                    <input class="form-control" name="maloai" type="text" readonly="readonly" value="<?php echo $Loai->getMaloai(); ?>">
												</td>
											</tr>
												...
												<td>
                                                                                                    <input class="form-control" name="tenloai" type="text" placeholder="Nhập tên loại" value="<?php echo $Loai->getTenloai(); ?>">
												</td>
											</tr>
											<tr>
												<td colspan="2">
