...
if(isset($_POST['capnhat'])){
    $masach = $_POST['masach1'];
    $tensach = $_POST['tensach'];
    $gia = $_POST['gia'];
    $tacgia = $_POST['tacgia'];
    $anh = $_POST['anh'];
    $maloai = $_POST['maloai'];
    $kt = SachBo::suaSach($masach,$tensach,$gia,$anh,$tacgia,$maloai);
}
$sach = SachBo::get1Sach($_GET['masach']);
...
<div class="col-md-12">
    <?php
										if(isset($kt)){
										if($kt != 0){
										echo "Đã cập nhật sách: ".$_POST['tensach'];
										}
										else {
...
<form action="" method="post">
									...
									<table class="table table-bordered text-center">
												...
												<td>
                                                                                                    <input readonly="readonly" class="form-control form-control-sm" name="masach1" type="text"  value="<?php echo $sach->getMasach(); ?>">
												</td>
											</tr>
												...
												<td>
                                                                                                    <input class="form-control form-control-sm" name="tensach" type="text" value="<?php echo $sach->getTensach(); ?>">
												</td>
											</tr>
                                                                                        <tr>
												...
												<td>
                                                                                                    <select class="form-control form-control-sm" name="maloai" >
                                                                                                     ...
                                                                                                     foreach ($lst_Loai as $ll){
                                                                                                         if($ll->getMaloai() == $sach->getMaloai()){
                                                                                                        ?>
                                                                                                        <option selected="selected" value="<?php echo $ll->getMaloai(); ?>"><?php echo $ll->getTenloai(); ?></option>
                                                                                                     <?php }
                                                                                                     else{?>
												...
												<td>
                                                                                                    <input class="form-control form-control-sm" name="tacgia" type="text" value="<?php echo $sach->getTacgia(); ?>">
												</td>
											</tr>
                                                                                        <tr>
												<td style="width: 150px;">Giá</td>
												<td>
                                                                                                    <input class="form-control form-control-sm" name="gia" type="text" value="<?php echo $sach->getGia(); ?>">
												</td>
											</tr>
                                                                                        <tr>
												<td style="width: 150px;">Ảnh</td>
												<td>
                                                                                                    <input class="form-control form-control-sm" value="<?php echo $sach->getAnh(); ?>" name="anh" type="file" >
												</td>
											</tr>
											<tr>
												<td colspan="2">
													<input type="submit" class="btn btn-sm btn-primary" name="capnhat" value="Cập nhật">
												</td>
											</tr>
										</tbody>
									</table>
